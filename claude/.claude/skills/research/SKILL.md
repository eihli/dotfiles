...
- Example: `/research momentum signal agents=4`
...
- For quant: look-ahead bias, survivorship bias, overfitting, regime changes
...
```
User: /research crypto momentum signal

Claude: [Spawns 3 parallel agents]
- Agent 1: Searching web for momentum signal best practices...
- Agent 2: Scanning codebase for existing signal implementations...
- Agent 3: Researching momentum signal pitfalls...

[Agents complete]

Based on research, a few questions:
1. Timeframe: intraday (minutes) or swing (days/weeks)?
2. Assets: single asset or cross-asset momentum?
3. Do you have historical data already, or need to fetch?

[User answers]

[Writes design-crypto-momentum-signal.md]

Design spec written to `design-crypto-momentum-signal.md`. Review before implementing.
```
